...
class HistoricoCorridasMotoca extends StatefulWidget {
  const HistoricoCorridasMotoca({Key? key}) : super(key: key);

  @override
  State<HistoricoCorridasMotoca> createState() =>
      _HistoricoCorridasMotocaState();
}

class _HistoricoCorridasMotocaState extends State<HistoricoCorridasMotoca> {
  dynamic corridas = [];
  ...
  Future<dynamic> buscarCorridas() async {
    var statusFiltros = ["finalizado", "cancelado"];
    if (filtrarPorStatus) statusFiltros = [statusParaFiltrar];

    return await buscarCorridasMotoca(
